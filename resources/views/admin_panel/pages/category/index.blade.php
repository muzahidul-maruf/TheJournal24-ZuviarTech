...
@section('news_category_menu_active', 'active')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            ...
                            <div class="ml-auto">
                                <a class="btn btn-sm btn-info" href="{{ route('admin.news.category.create') }}"
                                        ...
                                        @foreach ($all_cat as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($data->status == 1)
                                                        <a
                                                            href="{{ route('admin.news.category.status-update', $data->id) }}">
                                                ...
                                                <td>
                                                    @if ($data->is_popular == 1)
                                                        <a
                                                            href="{{ route('admin.news.category.popularity-status-update', $data->id) }}">
                                                            <button class="btn btn-success btn-xs"
                                                ...
                                                <td>
                                                    <a data-toggle="tooltip" data-placement="top" title="Edit"
                                                        href="{{ route('admin.news.category.edit', $data->id) }}"
                                                        type="button" class="btn btn-warning btn-xs mb-1">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                    <form class="d-inline"
                                                        action="{{ route('admin.news.category.destroy', $data->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
